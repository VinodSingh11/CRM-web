   ...
   <div class="w_content">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" >
            <li><a href="filter.php?status=Make Call&filter=status">Make Call</a></li>
            <li><a href="filter.php?status=Follow Up-1&filter=status">Follow Up-1</a></li>
            <li><a href="filter.php?status=Follow Up-2&filter=status">Follow Up-2</a></li>
			<li><a href="filter.php?status=Mitting Schedule&filter=status">Mitting Schedule</a></li>
            <li><a href="filter.php?status=Mitting Over&filter=status">Mitting Over</a></li>
            <li><a href="filter.php?status=Onboarded&filter=status">Onboarded</a></li>
			<li><a href="filter.php?status=Missed&filter=status">Missed</a></li>
          ...
          <ul class="dropdown-menu" >
            <li><a href="filter.php?Catagory=Design&filter=catagory">Design</a></li>
            <li><a href="filter.php?Catagory=Development&filter=catagory">Development</a></li>
            <li><a href="filter.php?Catagory=Marketting&filter=catagory">Marketting</a></li>
...
$sql = "SELECT * FROM lead order by lead_id desc";
$result = $conn->query($sql);?>
<table class=" table table-striped table-bordered">
			<tr><th>lead_id</th><th>lead name</th><th>catagory 1</th><th>catagory 2</th><th>catagory 3</th><th>status</th></tr>
			<?php
if ($result->num_rows > 0) {
	...
	$id= $row['lead_id'];
			...
			<td><?php echo $row['dept2']; ?></td>
			<td><?php echo $row['dept3']; ?></td>
			<td><?php echo $row['status']; ?></td>
			<td>
			<a href="status.php?id=<?php echo $id?>" class="btn btn-danger">Update</a>&nbsp;<a href="leaddetail.php?id=<?php echo $id?>" class="btn btn-danger">Detail</a>&nbsp;<a href="deletelead.php?id=<?php echo $id?>" class="btn btn-danger">Delete</a></td></tr>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<!--	<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Lead</span></a></li>-->
										 <li id="menu-academico" ><a href="index.html"><i class="fa fa-user"></i> <span> Lead</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										...
										<li id="menu-academico" ><a href="invoicedetail.php"><i class="fa fa-user"></i> <span> Invoice</span> <span class="fa fa-angle-right" style="float: right"></span></a>
