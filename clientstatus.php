...
<div class="women_main">
   ...
   <div class="w_content">
		...
		$sql1 = "SELECT * FROM milestone where client_id='$id' order by m_id desc";
		...
		?>
										...
										<form class="form-horizontal" action="setmilestone.php?id=<?php echo $id?>&email=<?php echo $email?>&per="<?php echo $per?>" method="post">
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Milestone Completed</label>
											<div class="col-sm-8">
												<select name="milestone" class="form-control1">
		...
		?>
															...
															<option value="<?php echo $x?>"><?php echo $x."-".$milestone?></option>
															<?php $x++;	}}
														?>
										...
										<center>
									<input type="submit" vlalue="Update" class="btn btn-danger "></center>
										</form>
