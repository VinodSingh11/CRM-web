   ...
   <div class="w_content">
		...
		?>
										...
										<form class="form-horizontal" action="" method="post">
											...
											<label for="disabledinput" class="col-sm-2 control-label">Make call</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Make call&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>


											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Follow up 1</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Follow up 1&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Follow up 1&id=<?php echo $id?>" class="btn btn-danger">no</a>
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Follow up 2</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Follow up 2&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Mitting Schedule</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Mitting Schedule&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Mitting over</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Mitting over&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">OnBoarded</label>
											<div class="col-sm-8">
												<a href='yes.php?status=OnBoarded&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>

											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Missed</label>
											<div class="col-sm-8">
												<a href='yes.php?status=Missed&id=<?php echo $id?>' class="btn btn-danger">yes</button></a>
												<a href="no.php?status=Missed&id=<?php echo $id?>" class="btn btn-danger">no</a>
