...
<div class="women_main">
   ...
   <div class="w_content">
		...
		?>
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Contact Person</label>
											<div class="col-sm-8">
											<label for="focusedinput" class="col-sm-2 control-label"><?php echo $poc ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Source</label>
											<div class="col-sm-8">
											<label for="focusedinput" class="col-sm-2 control-label"><?php echo $source ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Catagory-1</label>
											<div class="col-sm-8">
											<label for="focusedinput" class="col-sm-2 control-label"><?php echo $dept1 ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Catagory-2</label>
											<div class="col-sm-8">
											<label for="focusedinput" class="col-sm-2 control-label"><?php echo $dept2 ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Catagory-3</label>
											<div class="col-sm-8">
											<label for="focusedinput" class="col-sm-2 control-label"><?php echo $dept3 ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Expected Budget</label>
											<div class="col-sm-8">
														<label for="focusedinput" class="col-sm-2 control-label"><?php echo $budget ?></label>
											</div>
										</div>
											<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Status</label>
											<div class="col-sm-8">
														<label for="focusedinput" class="col-sm-2 control-label"><?php echo $status ?></label>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Note</label>
											<div class="col-sm-8">
														<label for="focusedinput" class="col-sm-2 control-label"><?php echo $note ?></label>
											</div>
										</div>								
