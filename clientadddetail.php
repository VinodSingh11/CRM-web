...
<div class="women_main">
   ...
   <div class="w_content">
		...
		?>
										...
										<form class="form-horizontal" action="insertclient.php?id=<?php echo $id ?>" method="post">
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">Name</label>
											<div class="col-sm-8">
												<input type="text" class="form-control1" id="focusedinput" placeholder="" name="name" value="<?php echo $name ?>" required>
											</div>
											<div class="col-sm-2">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input  type="email" class="form-control1" id="" placeholder="Email" name="email" value="<?php echo $email ?>" required>
											</div>
										</div>
											<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Mobile</label>
											<div class="col-sm-8">
												<input  type="text" class="form-control1" id="" placeholder="Mobile" name="mobile" value="<?php echo $mobile ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Billing Address</label>
											<div class="col-sm-8">
												<textarea name="billing_addr" rows="4" placeholder=" Billing Address" style="width:100%"></textarea>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Project Detail</label>
											<div class="col-sm-8">
												<textarea name="project_detail" rows="4" placeholder=" Project Detail" style="width:100%"></textarea>
											</div></div>
											<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Total Amount</label>
											<div class="col-sm-8">
												<input  type="number" class="form-control1" id="" placeholder="Total Amount (RS.)" name="total" value="" required>
											</div>
										</div>
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Milestone</label>
											<div class="col-sm-8">
												<input  type="number" name="milestone" min="1"class="form-control1" id="" placeholder=" No. of Milestone" name="mobile" " required>
											</div>
										</div>
										...
										<center>
									<input type="submit" vlalue="save" class="btn btn-danger "></center>
