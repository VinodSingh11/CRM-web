...
<div class="women_main">
   ...
   <div class="w_content">
		...
		?>
										...
										<form class="form-horizontal" action="insertmilestone.php?id=<?php echo $id ?>&milestone=<?php echo $milestone ?>" method="post">
									<?php 
										
														for ($x = 1; $x <=$milestone; $x++) {?>
															<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Milestone-<?php echo $x?></label>
											<div class="col-sm-8">
												<input  type="text" class="form-control1" id="" placeholder="Mobile" name="milestone_<?php echo $x?>" value="" required>
											</div>
										</div>
															<?php	}
														?>
										...
										<center>
									<a href="updatemilestone.php?id=<?php echo $id ?>" class="btn btn-danger">Add one</a>
