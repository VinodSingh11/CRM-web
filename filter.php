...
<div class="women_main">
   ...
   <div class="w_content">
		...
		if($filter=="status"){
		$status=$_GET['status'];
$sql = "SELECT * FROM lead where status='$status'";
...
if ($result->num_rows > 0) {
	...
	$id= $row['lead_id'];
			...
			<td>
			<a href="status.php?id=<?php echo $id?>" class="btn btn-danger">Update</a>&nbsp;<a href="leaddetail.php?id=<?php echo $id?>" class="btn btn-danger">Detail</a></td></tr>
...
$sql = "SELECT * FROM lead dept1='$catagory' or dept2='$catagory' or dept3='$catagory'";
$result = $conn->query($sql);?>
<table class=" table table-striped table-bordered">
			<tr><th>lead_id</th><th>lead name</th><th>catagory 1</th><th>catagory 2</th><th>catagory 3</th><th>status</th></tr>
			<?php
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<!--	<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Lead</span></a></li>-->
										 <li id="menu-academico" ><a href="home.html"><i class="fa fa-user"></i> <span> Lead</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										...
										<li id="menu-academico" ><a href="client.php"><i class="fa fa-user"></i> <span> Client</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="Client.html">Add New</a></li>
											<li id="menu-academico-avaliacoes" ><a href="addlead1.html">Deatil</a></li>
											<!--<li id="menu-academico-boletim" ><a href="sunglasses.html">Sunglasses</a></li>-->
										  </ul>
										</li>
