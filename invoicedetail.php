...
<div class="women_main">
   ...
   <div class="w_content">
		...
		?>
										...
										<form class="form-horizontal" action="invoice.php?id=<?php echo $id?>" method="post">
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">item</label>
											<div class="col-sm-8">
												<input type="text" class="form-control1" id="focusedinput" placeholder="" name="item" value="" required>
											</div>
											<div class="col-sm-2">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="number" class="form-control1" id="focusedinput" placeholder="NO." name="Qty" value="" required>
											</div>
											<div class="col-sm-2">
										...
										<div class="form-group">
											<label for="disabledinput" class="col-sm-2 control-label">Amount</label>
											<div class="col-sm-8">
												<input  type="number" min="0"class="form-control1" id="" placeholder="Amount" name="amount" value="" required>
											</div>
