...
<table class=" table table-striped table-bordered">
			<tr><th>client_id</th><th>client name</th><th>email</th><th>OnBoarding Date</th><th>Work Status</th><th>Add/View Detail</th></tr>
			<?php
if ($result->num_rows > 0) {
	...
	$per=round((($workstatus/$milestone)*100),2);
               ...
               ?>			
			<tr class=""><td><?php echo $row['client_id']; ?></a></td>
			...
			<td> 
				 ...
				 aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $per?>%">
						<?php echo $per?>% Complete (success)
													...
													</div>&nbsp; <a href="clientstatus.php?id=<?php echo $id?>" class="btn btn-danger">Update</a>
		</td>
			<td><a href="clientdetail.php?id=<?php echo $row['client_id']; ?>" class="btn btn-danger">Detail</a></td></tr>
			<td><a href="invoicedetail.php?id=<?php echo $row['client_id']; ?>" class="btn btn-danger">Invoice</a></td></tr>
